...
public class DynamicSpringManagedTransaction implements Transaction {
    ...
    protected TransactionProxy getProxy() {
        return connectionMap.get(DataSourceHolder.getActiveSourceName());
    }
    ...
    protected void addProxy(TransactionProxy proxy) {
        connectionMap.put(DataSourceHolder.getActiveSourceName(), proxy);
    }
    ...
    public Connection getConnection() throws SQLException {
        ...
        String dsId = DataSourceHolder.getActiveSourceName();
        ...
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug(
                    "DataSource (" + DataSourceHolder.getActiveSourceName()+ ") JDBC Connection ["
                            + connection
                            + "] will"
